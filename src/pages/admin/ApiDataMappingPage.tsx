...
const API_ENDPOINTS: ApiEndpointInfo[] = [
  ...
  },
  {
    ...
    description: "Syncs payment transactions including purchases and payment records.",
    edgeFunction: "sync-arketa-payments",
    apiEndpoint: "/partnerApi/v0/{partnerId}/purchases + /payments",
    pagination: "Query params (limit, start_date, end_date)",
    dateRange: {
      ahead: "Same day",
      behind: "Same day",
    ...
    fieldsMapped: [
      { apiField: "id", dbField: "external_id", nullable: false },
      { apiField: "client_id", dbField: "client_id", nullable: true },
      { apiField: "amount / total", dbField: "amount", transformation: "Checks 'amount' then 'total', defaults to 0", nullable: true },
      { apiField: "type", dbField: "payment_type", transformation: "Defaults to 'purchase'", nullable: true },
      { apiField: "status", dbField: "status", transformation: "Defaults to 'completed'", nullable: true },
      { apiField: "created_at / date", dbField: "payment_date", transformation: "Uses created_at or date, defaults to now()", nullable: true },
      { apiField: "notes", dbField: "notes", nullable: true },
      { apiField: "(full response)", dbField: "raw_data", nullable: true },
    ],
    fieldsNotPulled: [
      "currency",
    ...
    nullFields: ["client_id", "notes", "description", "amount_refunded", "promo_code"],
    transformations: [
      "Amount fallback: Checks 'amount' field, then 'total', defaults to 0",
      "Date fallback: Uses 'created_at' or 'date', defaults to current timestamp",
      "Type default: Defaults to 'purchase' when not specified",
    ],
  },
  {
    id: "sling_users",
