...
const badgeVariants = cva(
  "inline-flex items-center rounded-none border px-3 py-1 text-[10px] uppercase tracking-widest font-normal transition-opacity duration-300 focus:outline-none focus:ring-1 focus:ring-ring",
  {
    variants: {
      variant: {
