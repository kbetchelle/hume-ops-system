...
-- PDF documents, allowing staff to flag individual pages rather than entire
-- documents. Includes page number and context fields.
-- ============================================================================
...
-- --------------------------------------------------------------------------
-- 2. Add constraint to ensure page number is positive
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- 3. Create index for querying flags by page
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- 4. Create index for finding all page-specific flags
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- 6. Create helper function to get flags for a specific PDF page
-- --------------------------------------------------------------------------
...
COMMENT ON FUNCTION get_pdf_page_flags(uuid, integer) IS
  'Get all pending flags for a PDF page. If page_num is provided, returns flags for that specific page plus document-level flags. If page_num is NULL, returns all flags for the document.';

-- --------------------------------------------------------------------------
-- 7. Create helper view for flag inbox with page numbers
-- --------------------------------------------------------------------------
