      ...
      <div className="w-7/12 flex flex-col">
        <Card ref={noteCardRef} className="border flex flex-col flex-1 cursor-text" onClick={() => setIsEditing(true)}>
          ...
          <CardContent className="flex-1 flex flex-col min-h-0">
            {isEditing ? <RichTextEditor value={noteContent} onChange={setNoteContent} placeholder="Click to add notes..." minHeight="100%" className="flex-1" /> : <div className="prose prose-sm max-w-none text-xs flex-1 overflow-auto [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_a]:text-primary [&_a]:underline border-primary py-[3px] mx-[2px] my-[4px] border" dangerouslySetInnerHTML={{
