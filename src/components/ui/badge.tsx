...
const badgeVariants = cva(
  "inline-flex items-center rounded-none border px-1 py-0.5 text-[8px] uppercase tracking-widest font-normal transition-opacity duration-300 focus:outline-none focus:ring-1 focus:ring-ring",
  {
    variants: {
      variant: {
